...
public class DistrictResponse {
    ...
    @SerializedName("Data")
    @Expose
    private ArrayList<DistrictEntity> data;


    public DistrictResponse(Boolean status, String msg, String cap, String s_Key, ArrayList<DistrictEntity> data) {
        this.status = status;
        this.msg = msg;
        this.cap = cap;
        this.s_Key = s_Key;
    ...
    public DistrictResponse(DistrictResponse obj) {
    ...
    public ArrayList<DistrictEntity> getData() {
        return data;
    }

    public void setData(ArrayList<DistrictEntity> data) {
        this.data = data;
    }
}
