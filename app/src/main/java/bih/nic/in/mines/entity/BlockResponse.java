...
public class BlockResponse {
    ...
    @SerializedName("Data")
    @Expose
    private ArrayList<BlockEntity> data;


    public BlockResponse(Boolean status, String msg, String cap, String s_Key, ArrayList<BlockEntity> data) {
        this.status = status;
        this.msg = msg;
        this.cap = cap;
        this.s_Key = s_Key;
    ...
    public BlockResponse(BlockResponse obj) {
    ...
    public ArrayList<BlockEntity> getData() {
        return data;
    }

    public void setData(ArrayList<BlockEntity> data) {
        this.data = data;
    }
}
