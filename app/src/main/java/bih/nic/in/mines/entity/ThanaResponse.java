...
public class ThanaResponse {
    ...
    @SerializedName("Data")
    @Expose
    private ArrayList<ThanaEntity> data;


    public ThanaResponse(Boolean status, String msg, String cap, String s_Key, ArrayList<ThanaEntity> data) {
        this.status = status;
        this.msg = msg;
        this.cap = cap;
        this.s_Key = s_Key;
    ...
    public ThanaResponse(ThanaResponse obj) {
    ...
    public ArrayList<ThanaEntity> getData() {
        return data;
    }

    public void setData(ArrayList<ThanaEntity> data) {
        this.data = data;
    }
}
