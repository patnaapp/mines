...
public class PurposeResponse {
    ...
    @SerializedName("Data")
    @Expose
    private ArrayList<PurposeEntity> data;


    public PurposeResponse(Boolean status, String msg, String cap, String s_Key, ArrayList<PurposeEntity> data) {
        this.status = status;
        this.msg = msg;
        this.cap = cap;
        this.s_Key = s_Key;
    ...
    public PurposeResponse(PurposeResponse obj) {
    ...
    public ArrayList<PurposeEntity> getData() {
        return data;
    }

    public void setData(ArrayList<PurposeEntity> data) {
        this.data = data;
    }
}
