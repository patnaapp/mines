...
public class DeclarationResponse {
    ...
    @SerializedName("Data")
    @Expose
    private ArrayList<DeclarationEntity> data;


    public DeclarationResponse(Boolean status, String msg, String cap, String s_Key, ArrayList<DeclarationEntity> data) {
        this.status = status;
        this.msg = msg;
        this.cap = cap;
        this.s_Key = s_Key;
    ...
    public DeclarationResponse(DeclarationResponse obj) {
    ...
    public ArrayList<DeclarationEntity> getData() {
        return data;
    }

    public void setData(ArrayList<DeclarationEntity> data) {
        this.data = data;
    }
}
